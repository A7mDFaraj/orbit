...
export default function WhatsAppBusinessAPIPage() {
  ...
  const content = {
    ...
    benefits: [
      {
        en: 'Official and trusted communication',
        ar: 'تواصل رسمي وموثوق',
      },
      {
        en: 'Message automation',
        ar: 'أتمتة الرسائل',
      },
      {
        en: 'Professional conversation management',
        ar: 'إدارة محادثات احترافية',
      },
      {
        en: 'Enhanced customer confidence',
        ar: 'تعزيز ثقة العملاء',
      },
    ],
  };
