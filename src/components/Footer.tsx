...
export default function Footer() {
  ...
  const solutions = [
    { name: isRTL ? 'الرسائل النصية' : 'SMS Platform', href: '/solutions/sms-platform' },
    { name: isRTL ? 'واتساب اعمال API' : 'WhatsApp Business API', href: '/solutions/whatsapp-business-api' },
    { name: isRTL ? 'اوتايم OTime' : 'OTime - Attendance & HR', href: '/solutions/otime' },
    { name: isRTL ? 'البوابة الحكومية Gov Gate' : 'Gov Gate - Government Portal', href: '/solutions/gov-gate' },
  ];
